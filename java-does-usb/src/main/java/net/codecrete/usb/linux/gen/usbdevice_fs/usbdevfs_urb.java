...
public class usbdevfs_urb {
    ...
    private static final OfInt number_of_packets$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$126:2"), groupElement("number_of_packets"));
     ...
     * }
     */
    public static final OfInt number_of_packets$layout() {
        return number_of_packets$LAYOUT;
    }

    private static final long number_of_packets$OFFSET = 36;
     ...
     * }
     */
    public static final long number_of_packets$offset() {
        return number_of_packets$OFFSET;
    }
     ...
     * }
     */
    public static int number_of_packets(MemorySegment struct) {
        return struct.get(number_of_packets$LAYOUT, number_of_packets$OFFSET);
    }
     ...
     * }
     */
    public static void number_of_packets(MemorySegment struct, int fieldValue) {
        struct.set(number_of_packets$LAYOUT, number_of_packets$OFFSET, fieldValue);
    }

    private static final OfInt stream_id$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$126:2"), groupElement("stream_id"));
     ...
     * }
     */
    public static final OfInt stream_id$layout() {
        return stream_id$LAYOUT;
    }

    private static final long stream_id$OFFSET = 36;
     ...
     * }
     */
    public static int stream_id(MemorySegment struct) {
     ...
     * }
     */
    public static void stream_id(MemorySegment struct, int fieldValue) {
