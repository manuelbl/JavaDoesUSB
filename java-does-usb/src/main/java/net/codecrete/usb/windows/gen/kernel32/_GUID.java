...
public class _GUID {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Kernel32.C_LONG.withName("Data1"),
        Kernel32.C_SHORT.withName("Data2"),
        Kernel32.C_SHORT.withName("Data3"),
        MemoryLayout.sequenceLayout(8, Kernel32.C_CHAR).withName("Data4")
    ).withName("_GUID");
