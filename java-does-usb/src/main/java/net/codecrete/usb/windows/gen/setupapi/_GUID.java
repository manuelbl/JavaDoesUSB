...
public class _GUID {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        SetupAPI.C_LONG.withName("Data1"),
        SetupAPI.C_SHORT.withName("Data2"),
        SetupAPI.C_SHORT.withName("Data3"),
        MemoryLayout.sequenceLayout(8, SetupAPI.C_CHAR).withName("Data4")
    ).withName("_GUID");
