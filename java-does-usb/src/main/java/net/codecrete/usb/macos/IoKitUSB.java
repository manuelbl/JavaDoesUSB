...
public class IoKitUSB {
    ...
    public static int CreateDeviceAsyncEventSource(MemorySegment self, MemorySegment source) {
        return IOUSBDeviceInterface187.CreateDeviceAsyncEventSource(getVtable(self), Arena.global()).apply(self,
                source);
    }
    ...
    public static int GetConfigurationDescriptorPtr(MemorySegment self, byte configIndex, MemorySegment descHolder) {
        return IOUSBDeviceInterface187.GetConfigurationDescriptorPtr(getVtable(self), Arena.global()).apply(self,
    ...
    public static int SetConfiguration(MemorySegment self, byte configValue) {
        return IOUSBDeviceInterface187.SetConfiguration(getVtable(self), Arena.global()).apply(self, configValue);
    }
    ...
    public static int CreateInterfaceIterator(MemorySegment self, MemorySegment req, MemorySegment iter) {
        return IOUSBDeviceInterface187.CreateInterfaceIterator(getVtable(self), Arena.global()).apply(self, req, iter);
    }
    ...
    public static int DeviceRequestAsync(MemorySegment self, MemorySegment deviceRequest, MemorySegment callback,
        ...
        return IOUSBDeviceInterface187.DeviceRequestAsync(getVtable(self), Arena.global()).apply(self, deviceRequest,
                callback, refCon);
    }
    ...
    public static int GetPipeProperties(MemorySegment self, byte pipeRef, MemorySegment directionHolder,
        ...
        return IOUSBInterfaceInterface190.GetPipeProperties(getVtable(self), Arena.global()).apply(self, pipeRef,
    ...
    public static int ReadPipeAsync(MemorySegment self, byte pipeRef, MemorySegment buf, int size,
        ...
        return IOUSBInterfaceInterface190.ReadPipeAsync(getVtable(self), Arena.global()).apply(self, pipeRef, buf,
    ...
    public static int ReadPipeAsyncTO(MemorySegment self, byte pipeRef, MemorySegment buf, int size,
                                      ...
                                      MemorySegment refcon) {
        return IOUSBInterfaceInterface190.ReadPipeAsyncTO(getVtable(self), Arena.global()).apply(self, pipeRef, buf,
    ...
    public static int WritePipeAsync(MemorySegment self, byte pipeRef, MemorySegment buf, int size,
                                     MemorySegment callback, MemorySegment refcon) {
        return IOUSBInterfaceInterface190.WritePipeAsync(getVtable(self), Arena.global()).apply(self, pipeRef, buf,
                size, callback, refcon);
    }
    ...
    public static int WritePipeAsyncTO(MemorySegment self, byte pipeRef, MemorySegment buf, int size,
                                       int noDataTimeout, int completionTimeout, MemorySegment callback,
                                       MemorySegment refcon) {
        return IOUSBInterfaceInterface190.WritePipeAsyncTO(getVtable(self), Arena.global()).apply(self, pipeRef, buf,
                size, noDataTimeout, completionTimeout, callback, refcon);
    }
    ...
    public static int ClearPipeStallBothEnds(MemorySegment self, byte pipeRef) {
        return IOUSBInterfaceInterface190.ClearPipeStallBothEnds(getVtable(self), Arena.global()).apply(self, pipeRef);
    }
    ...
    public static int CreateInterfaceAsyncEventSource(MemorySegment self, MemorySegment source) {
        return IOUSBInterfaceInterface190.CreateInterfaceAsyncEventSource(getVtable(self), Arena.global()).apply(self
                , source);
    }
}
