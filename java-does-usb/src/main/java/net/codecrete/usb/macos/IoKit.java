...
public class IoKit {
    ...
    public static final MemorySegment kIOFirstMatchNotification = ioKitSession.allocateUtf8String(
            "IOServiceFirstMatch");
    ...
    public static final GroupLayout IOCFPlugInInterface$Struct = MemoryLayout.structLayout(ADDRESS.withName(
            "_reserved"), // void *_reserved;
            ...
            ADDRESS.withName("Probe"), // IOReturn (*Probe)(void *thisPointer, CFDictionaryRef propertyTable,
            // io_service_t service, SInt32 * order);
            ADDRESS.withName("Start"), // IOReturn (*Start)(void *thisPointer, CFDictionaryRef propertyTable,
     ...
     */
    private static Addressable IOCFPlugInInterfaceFunctionAddress(MemoryAddress thisPointer, VarHandle varHandle,
    ...
    private static final VarHandle IUnknown_QueryInterface = IOCFPlugInInterface$Struct.varHandle(groupElement(
            "QueryInterface"));
    private static final MethodHandle QueryInterface$Func = linker.downcallHandle(FunctionDescriptor.of(JAVA_INT,
            ADDRESS, CFUUIDBytes, ADDRESS));
    ...
    private static final MethodHandle AddRef$Func = linker.downcallHandle(FunctionDescriptor.of(JAVA_INT, ADDRESS));
    ...
    private static final MethodHandle Release$Func = linker.downcallHandle(FunctionDescriptor.of(JAVA_INT, ADDRESS));
    ...
    private static final MethodHandle IOObjectRelease$Func = linker.downcallHandle(ioKitLookup.lookup(
            "IOObjectRelease").get(), FunctionDescriptor.of(JAVA_INT, JAVA_INT));
    ...
    private static final MethodHandle IOIteratorNext$Func =
            linker.downcallHandle(ioKitLookup.lookup("IOIteratorNext").get(), FunctionDescriptor.of(JAVA_INT,
                    JAVA_INT));
    ...
    // kern_return_t IOCreatePlugInInterfaceForService(io_service_t service, CFUUIDRef pluginType, CFUUIDRef
    // interfaceType, IOCFPlugInInterface ***theInterface, SInt32 *theScore);
    private static final MethodHandle IOCreatePlugInInterfaceForService$Func =
            linker.downcallHandle(ioKitLookup.lookup("IOCreatePlugInInterfaceForService").get(),
                    FunctionDescriptor.of(JAVA_INT, JAVA_INT, ADDRESS, ADDRESS, ADDRESS, ADDRESS));

    public static int IOCreatePlugInInterfaceForService(int service, Addressable pluginType,
                                                        Addressable interfaceType, Addressable intf,
                                                        Addressable score) {
        try {
            return (int) IOCreatePlugInInterfaceForService$Func.invokeExact(service, pluginType, interfaceType, intf,
                    score);
        } catch (Throwable e) {
            throw new RuntimeException(e);
        }
    ...
    // CFTypeRef IORegistryEntryCreateCFProperty(io_registry_entry_t entry, CFStringRef key, CFAllocatorRef
    // allocator, IOOptionBits options);
    private static final MethodHandle IORegistryEntryCreateCFProperty$Func =
            linker.downcallHandle(ioKitLookup.lookup("IORegistryEntryCreateCFProperty").get(),
                    FunctionDescriptor.of(ADDRESS, JAVA_INT, ADDRESS, ADDRESS, JAVA_INT));

    public static MemoryAddress IORegistryEntryCreateCFProperty(int entry, String key, Addressable allocator,
                                                                int options) {
        try {
            var keyStr = CoreFoundationHelper.createCFStringRef(key);
            var propValue = (MemoryAddress) IORegistryEntryCreateCFProperty$Func.invokeExact(entry,
                    (Addressable) keyStr, allocator, options);
    ...
    private static final MethodHandle IONotificationPortCreate$Func = linker.downcallHandle(ioKitLookup.lookup(
            "IONotificationPortCreate").get(), FunctionDescriptor.of(ADDRESS, JAVA_INT));
    ...
    private static final MethodHandle IONotificationPortGetRunLoopSource$Func =
            linker.downcallHandle(ioKitLookup.lookup("IONotificationPortGetRunLoopSource").get(),
    ...
    private static final MethodHandle IORegistryEntryGetRegistryEntryID$Func =
            linker.downcallHandle(ioKitLookup.lookup("IORegistryEntryGetRegistryEntryID").get(),
    ...
    // kern_return_t IOServiceAddMatchingNotification(IONotificationPortRef notifyPort, const io_name_t
    // notificationType, CFDictionaryRef matching, IOServiceMatchingCallback callback, void *refCon, io_iterator_t
    // *notification);
    private static final MethodHandle IOServiceAddMatchingNotification$Func =
            linker.downcallHandle(ioKitLookup.lookup("IOServiceAddMatchingNotification").get(),
                    FunctionDescriptor.of(JAVA_INT, ADDRESS, ADDRESS, ADDRESS, ADDRESS, ADDRESS, ADDRESS));

    public static int IOServiceAddMatchingNotification(Addressable notifyPort, Addressable notificationType,
                                                       Addressable matching, Addressable callback, Addressable refCon
            , Addressable notificationHolder) {
        try {
            return (int) IOServiceAddMatchingNotification$Func.invokeExact(notifyPort, notificationType, matching,
                    callback, refCon, notificationHolder);
        } catch (Throwable t) {
            throw new RuntimeException(t);
        }
    }
    ...
    private static final MethodHandle IOServiceMatching$Func = linker.downcallHandle(ioKitLookup.lookup(
            "IOServiceMatching").get(), FunctionDescriptor.of(ADDRESS, ADDRESS));
    ...
    public static final MemoryAddress kIOUSBDeviceUserClientTypeID = CoreFoundation.CFUUIDCreateFromUUIDBytes(NULL,
    ...
    public static final MemoryAddress kIOUSBInterfaceUserClientTypeID = CoreFoundation.CFUUIDCreateFromUUIDBytes(NULL
    ...
    public static final MemoryAddress kIOUSBDeviceInterfaceID100 = CoreFoundation.CFUUIDCreateFromUUIDBytes(NULL,
    ...
    public static final MemoryAddress kIOUSBInterfaceInterfaceID100 = CoreFoundation.CFUUIDCreateFromUUIDBytes(NULL,
    ...
    public static final MemoryAddress kIOCFPlugInInterfaceID = CoreFoundation.CFUUIDCreateFromUUIDBytes(NULL,
